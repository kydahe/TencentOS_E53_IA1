...
static void data_template_init(qcloud_device_t *device)
{
    ...
    //light_profile.brightness    = 0.0;
	  light_profile.brightness    = read_brightness();
    ...
    light_property_handler.property_wrappers_of.brightness.property.type    = JSON_DATA_TYPE_INT32;
...
int data_template_light_thread(void)
{
    ...
    qcloud_device_create(&device, "BW1L2VQVIB", "dev001", "48vrenklLS333u6vhSPvgA==");
