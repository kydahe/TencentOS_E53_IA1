...
/* product Id  */
static char sg_product_id[MAX_SIZE_OF_PRODUCT_ID + 1]	 = "xxxx"; //need to modify

/* device name */
static char sg_device_name[MAX_SIZE_OF_DEVICE_NAME + 1]  = "xxxxx"; //need to modify
...
static char sg_device_secret[MAX_SIZE_OF_DEVICE_SECRET + 1] = "xxxx"; // need to modify
#endif
